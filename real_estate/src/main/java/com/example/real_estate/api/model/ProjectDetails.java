...
//     @Pattern(message="Project status should contain only letters and spaces", regexp = "^[A-Za-z\\s]+$")
...
//     @Pattern(message="Amenities should contain only letters and spaces", regexp = "^[A-Za-z\\s]+$")
//     private String amenities;

//     /**
//      * Information about covered parking availability.
//      */
//     @NotNull(message = "Covered parking details are required")
...
//     @Pattern(message="Banks should contain only letters and spaces", regexp = "^[A-Za-z\\s]+$")
